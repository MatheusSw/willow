...
public class RuleRepositoryTests
{
    ...
    public async Task CreateAsync_SavesRule_ReturnsOk()
    {
        ...
        var model = new admin_domain.Entities.Rule { Id = Guid.NewGuid(), FeatureId = Guid.NewGuid(), EnvironmentId = Guid.NewGuid(), Priority = 1, MatchType = admin_domain.Rules.MatchType.All, Conditions = new System.Collections.Generic.List<RuleCondition>() };
