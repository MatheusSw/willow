...
public sealed class ListEnvironmentsQueryHandler : IListEnvironmentsQueryHandler
{
    private readonly IEnvironmentRepository _repository;
    public ListEnvironmentsQueryHandler(IEnvironmentRepository repository) { _repository = repository; }
