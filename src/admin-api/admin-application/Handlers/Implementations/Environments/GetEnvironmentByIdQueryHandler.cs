...
public sealed class GetEnvironmentByIdQueryHandler : IGetEnvironmentByIdQueryHandler
{
    private readonly IEnvironmentRepository _repository;
    public GetEnvironmentByIdQueryHandler(IEnvironmentRepository repository) { _repository = repository; }
