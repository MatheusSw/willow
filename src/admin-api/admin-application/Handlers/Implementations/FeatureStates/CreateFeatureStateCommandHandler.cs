...
public sealed class CreateFeatureStateCommandHandler : ICreateFeatureStateCommandHandler
{
    private readonly IFeatureStateRepository _repository;
    public CreateFeatureStateCommandHandler(IFeatureStateRepository repository) { _repository = repository; }
