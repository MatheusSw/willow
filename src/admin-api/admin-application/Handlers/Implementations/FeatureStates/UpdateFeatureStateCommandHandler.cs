...
public sealed class UpdateFeatureStateCommandHandler : IUpdateFeatureStateCommandHandler
{
    private readonly IFeatureStateRepository _repository;
    public UpdateFeatureStateCommandHandler(IFeatureStateRepository repository) { _repository = repository; }
