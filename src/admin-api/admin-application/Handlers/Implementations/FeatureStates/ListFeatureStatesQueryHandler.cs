...
public sealed class ListFeatureStatesQueryHandler : IListFeatureStatesQueryHandler
{
    private readonly IFeatureStateRepository _repository;
    public ListFeatureStatesQueryHandler(IFeatureStateRepository repository) { _repository = repository; }
