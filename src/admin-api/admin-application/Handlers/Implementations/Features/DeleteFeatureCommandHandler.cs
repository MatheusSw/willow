...
public sealed class DeleteFeatureCommandHandler : IDeleteFeatureCommandHandler
{
    private readonly IFeatureRepository _repository;
    public DeleteFeatureCommandHandler(IFeatureRepository repository) { _repository = repository; }
