...
public sealed class ListFeaturesQueryHandler : IListFeaturesQueryHandler
{
    private readonly IFeatureRepository _repository;
    public ListFeaturesQueryHandler(IFeatureRepository repository) { _repository = repository; }
