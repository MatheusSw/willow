...
public sealed class ListProjectsQueryHandler : IListProjectsQueryHandler
{
    private readonly IProjectRepository _repository;
    public ListProjectsQueryHandler(IProjectRepository repository) { _repository = repository; }
