...
public class CreateRuleCommandHandlerTests
{
    ...
    public async Task HandleAsync_RepoSucceeds_ReturnsCreatedRule()
    {
        ...
        var cmd = new CreateRuleCommand { FeatureId = Guid.NewGuid(), EnvironmentId = Guid.NewGuid(), Priority = 1, MatchType = "all", Conditions = new List<RuleCondition>() };
    ...
    public async Task HandleAsync_RepoFails_ReturnsFailure()
    {
        ...
        var handler = new CreateRuleCommandHandler(repo.Object);
        var cmd = new CreateRuleCommand { FeatureId = Guid.NewGuid(), EnvironmentId = Guid.NewGuid(), Priority = 1, MatchType = "any", Conditions = new List<RuleCondition>() };
