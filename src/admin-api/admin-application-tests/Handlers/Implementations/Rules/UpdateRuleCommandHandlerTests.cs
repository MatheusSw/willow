...
public class UpdateRuleCommandHandlerTests
{
    ...
    public async Task HandleAsync_RepoSucceeds_ReturnsUpdatedRule()
    {
        ...
        var cmd = new UpdateRuleCommand { Id = Guid.NewGuid(), FeatureId = Guid.NewGuid(), EnvironmentId = Guid.NewGuid(), Priority = 1, MatchType = "all", Conditions = new List<RuleCondition>() };
    ...
    public async Task HandleAsync_RepoFails_ReturnsFailure()
    {
        ...
        var handler = new UpdateRuleCommandHandler(repo.Object);
        var cmd = new UpdateRuleCommand { Id = Guid.NewGuid(), FeatureId = Guid.NewGuid(), EnvironmentId = Guid.NewGuid(), Priority = 1, MatchType = "any", Conditions = new List<RuleCondition>() };
